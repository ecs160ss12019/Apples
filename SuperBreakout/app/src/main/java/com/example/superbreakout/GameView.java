...
class GameView extends SurfaceView implements Runnable{
     ...
     */
    private long FPS; // Frame rate of the game (rate at which the view refreshes)
    ...
    private volatile boolean playing; // can be accessed from outside the thread
    ...
    public void run() {
        while(playing){
            ...
            long thisFrameTime = System.currentTimeMillis() - frameStartTime;

            if(thisFrameTime > 0) {
                FPS = MILLIS_IN_SECOND / thisFrameTime;
            }
        }
        // run implementation
    }
     ...
     */
    private void startNewGame(int lvl){
        ...
        switch (level) {
            case 1:
                 ...
                 */
                balls[0].xVelocity = 40;
                balls[0].yVelocity = -80;
                break;
